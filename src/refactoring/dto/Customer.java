...
public class Customer {
	...
	public String statement(){
		...
		for(Rental each : rentals){
			...
			//1.일반물(2일)2000원,일일초과당1500원,적립1=>(2일,3000원) 일일초과2000, 적립1
			//2.아동물(3일)1500원,일일초과당1500,적립1=>(2일,2000원) 일일초과1500, 적립1
			//3.최신물(1일)3000원, 일일초과 3000,적립1+1=>(2일,4000원) 일일초과4000, 적립1+1
			//html형식으로 출력을 원함
	...
	public String htmlStatement(){
		...
		sb.append(String.format("<p>누적대여료 : <Em>%s</Em><br><p>적립 포인트 : <em>%s</em><br>", totalAmount, frequentRanterPoints));
